...
export class Init1749994498229 implements MigrationInterface {
    name = 'Init1749994498229'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "bid_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "amount" numeric NOT NULL, "lotId" uuid, "userId" uuid, CONSTRAINT "PK_4c928e34a0b5c9c794a67a52afe" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'buyer', 'seller')`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "firstName" character varying, "lastName" character varying, "email" character varying NOT NULL, "password" character varying(255) NOT NULL, "refreshToken" character varying, "role" "public"."users_role_enum" NOT NULL DEFAULT 'buyer', CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "user_email_index" ON "users" ("email") `);
        ...
        await queryRunner.query(`ALTER TABLE "bid_entity" ADD CONSTRAINT "FK_87b476f61d2bd7a1ec8928b7255" FOREIGN KEY ("lotId") REFERENCES "lots"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bid_entity" ADD CONSTRAINT "FK_94f8358469e29e22defac663458" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bid_entity" DROP CONSTRAINT "FK_94f8358469e29e22defac663458"`);
        await queryRunner.query(`ALTER TABLE "bid_entity" DROP CONSTRAINT "FK_87b476f61d2bd7a1ec8928b7255"`);
        ...
        await queryRunner.query(`DROP TABLE "bid_entity"`);
    }
